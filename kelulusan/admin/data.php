...
<div class="container">
	...
	<div class="row col-sm-8">
		<form class="form-horizontal well" method="post" action="dupload.php" enctype="multipart/form-data">
			<div class="form-group">
				<label for="importCsv" class="col-sm-3 control-label">CSV File</label>
				<div class="col-sm-9">
